...
def _filter_style_dict(kw, warn=True):
    """
...
def _get_style_dict(style, warn=True):
    """
    ...
    if style in ('default', 'original', 'proplot'):
        ...
        kw = _filter_style_dict(kw, warn=False)
    ...
    return _filter_style_dict(kw, warn=warn)
...
def _parse_style_spec(styles, allow_dictionary=True):
    """
